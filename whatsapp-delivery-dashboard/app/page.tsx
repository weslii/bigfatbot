"use client"
import { ArrowRight, BarChart3, Bell, Building2, CheckCircle, MessageSquare, Package, Zap, LogIn } from "lucide-react"
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent dark:from-slate-100 dark:to-slate-300">
                Get Started Today
              </h2>
              <p className="text-lg text-muted-foreground">
                Join hundreds of businesses already using our platform to streamline their delivery operations.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-white/80 to-blue-50/50 backdrop-blur-sm dark:from-slate-900/80 dark:to-blue-950/20 hover:shadow-2xl transition-all duration-500 group">
                <CardHeader className="text-center pb-4">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <CardDescription className="text-base text-muted-foreground">
                    Access your business dashboard to manage orders, track deliveries, and monitor your performance.
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <div className="space-y-3 mb-6">
                  ...
                  <Button
                    size="lg"
                    className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Login to Dashboard
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
